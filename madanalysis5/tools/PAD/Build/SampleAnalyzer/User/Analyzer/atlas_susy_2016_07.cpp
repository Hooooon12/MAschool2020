...
// -----------------------------------------------------------------------------
bool atlas_susy_2016_07::Initialize(const MA5::Configuration& cfg, const std::map<std::string,std::string>& parameters)
{
...
// -----------------------------------------------------------------------------
void atlas_susy_2016_07::Finalize(const SampleFormat& summary, const std::vector<SampleFormat>& files)
{
...
bool atlas_susy_2016_07::Execute(SampleFormat& sample, const EventFormat& event)
{
  Nevents = Nevents + 1;
