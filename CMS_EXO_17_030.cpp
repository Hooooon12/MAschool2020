...
bool CMS_EXO_17_030::Initialize(const MA5::Configuration& cfg, const std::map<std::string,std::string>& parameters)
{
  ...
  for (int i = 0; i < 4; i++) {
    ...
    */
    ...
    parton_pt_1[i] = new TH1D(Form("parton_pt_1_%d", i+1), Form("parton_pt_1_%d", i+1), 2000, 0, 2000);
    parton_pt_2[i] = new TH1D(Form("parton_pt_2_%d", i+1), Form("parton_pt_2_%d", i+1), 2000, 0, 2000);
    parton_pt_3[i] = new TH1D(Form("parton_pt_3_%d", i+1), Form("parton_pt_3_%d", i+1), 2000, 0, 2000);
    parton_pt_4[i] = new TH1D(Form("parton_pt_4_%d", i+1), Form("parton_pt_4_%d", i+1), 2000, 0, 2000);
    parton_pt_5[i] = new TH1D(Form("parton_pt_5_%d", i+1), Form("parton_pt_5_%d", i+1), 2000, 0, 2000);
    parton_pt_6[i] = new TH1D(Form("parton_pt_6_%d", i+1), Form("parton_pt_6_%d", i+1), 2000, 0, 2000);
